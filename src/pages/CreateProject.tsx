...
const CreateProject: React.FC = () => {
 const navigate = useNavigate();
  ...
  const [formData, setFormData] = useState<Firstproject>({
    _id: 0,
    coverImageUrl: '',
    price: 0,
    description: '',
      ...
      <div className="container mx-auto px-4 my-16">
        <div className="max-w-4xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="bg-gray-900/50 rounded-xl p-6 space-y-6">
              <h2 className="text-xl font-semibold text-purple-400 mb-4">Project description</h2>
              ...
              <div>
                <label htmlFor="detail" className="block text-sm font-medium text-gray-300 mb-2">
